...
class SavingsCalculatorUI {
    ...
    `;
        ...
        this.summaryRegion = resultsCard.querySelector('#bt-summary-region');
        this.summaryAnnouncer = resultsCard.querySelector('#bt-summary-announcer');
        this.tableBody = resultsCard.querySelector('#bt-table-body');
        this.showAllButton = resultsCard.querySelector('[data-action="toggle-rows"]');
        this.messageRegion = this.root.querySelector('#bt-message');
        this.rememberToggle = this.root.querySelector('#rememberInputs');
        this.mobileSummaryRegion = this.root.querySelector('#bt-mobile-summary');
        this.mobileSummaryCard = this.mobileSummaryRegion.querySelector('.bt-mobile-summary__card');
        ...
        const actionButtons = Array.from(resultsCard.querySelectorAll('.bt-actions .bt-button'));
        ...
        var _a;
        (_a = this.showAllButton) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => {
    ...
    updateMobileSummary() {
        var _a, _b;
        if (!this.mobileSummaryRegion || !this.mobileSummaryCard)
            return;
        if (!this.resultSummary) {
    ...
    focusResults() {
        ...
        if (desktopQuery.matches) {
            ...
            target === null || target === void 0 ? void 0 : target.scrollIntoView({ behavior, block: 'start' });
            if (this.summaryRegion) {
                window.setTimeout(() => {
    ...
    renderSummary() {
        ...
        const addMetric = (label, metricValue) => {
